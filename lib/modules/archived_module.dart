...
class ArchivedModule extends StatefulWidget {
  final String currentSearchText;
  const ArchivedModule({super.key, required this.currentSearchText});

  @override
  State<ArchivedModule> createState() => _ArchivedModuleState();
}

class _ArchivedModuleState extends State<ArchivedModule> {
  @override
